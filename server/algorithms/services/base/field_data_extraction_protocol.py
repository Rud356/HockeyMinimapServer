...
class FieldDataExtractionProtocol(Protocol):
    ...
    def get_field_data(
        ...
        :param anchor_center_point: Пользовательская ключевая точка в абсолютных координатах.
        :return: Информация о соотнесении точек и маске игрового поля на видео,
        где ключевые точки поля имеют исходный вид, а ключевые точки с видео - относительный.
        """
